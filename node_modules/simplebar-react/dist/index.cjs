    ...
    ***************************************************************************** */
    ...
    var SimpleBar = React__namespace.forwardRef(function (_a, ref) {
        ...
        Object.keys(otherProps).forEach(function (key) {
            if (Object.prototype.hasOwnProperty.call(SimpleBarCore__default["default"].defaultOptions, key)) {
        ...
        var classNames = __assign(__assign({}, SimpleBarCore__default["default"].defaultOptions.classNames), options.classNames);
        var scrollableNodeFullProps = __assign(__assign({}, scrollableNodeProps), { className: "".concat(classNames.contentWrapper).concat(scrollableNodeProps.className ? " ".concat(scrollableNodeProps.className) : ''), tabIndex: 0, role: 'region', 'aria-label': options.ariaLabel || SimpleBarCore__default["default"].defaultOptions.ariaLabel });
        React__namespace.useEffect(function () {
            ...
            if (elRef.current) {
                instance = new SimpleBarCore__default["default"](elRef.current, __assign(__assign(__assign({}, options), (scrollableNodeRef.current && {
